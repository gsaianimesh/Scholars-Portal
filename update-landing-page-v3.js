    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/20">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-5xl">
          <div className="inline-flex items-center gap-2.5 rounded-full border border-primary/20 bg-primary/5 px-5 py-2 text-sm font-medium text-primary mb-8 backdrop-blur-md animate-in fade-in slide-in-from-bottom-4 duration-1000">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto mb-12 leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300">
            Stop juggling emails, calendars, and spreadsheets. Schedule automatically emailed meetings, seamlessly track student tasks, evaluate work, and let our smart AI bot sit in on your meetings to take notes for you.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-500">
            {loggedIn ? (
              <Link href="/dashboard">
                <Button size="lg" className="rounded-full h-14 px-8 text-base gap-2 bg-primary hover:bg-primary/90 text-white shadow-xl shadow-primary/25 transition-all hover:-translate-y-1">
              ...
              <>
                <Link href="/signup">
                  <Button size="lg" className="rounded-full h-14 px-8 text-base gap-2 bg-foreground text-background hover:bg-foreground/90 shadow-xl transition-all hover:-translate-y-1 border-0">
                    Set Up Your Lab <ArrowRight className="h-5 w-5" />
                  </Button>
                </Link>
                <Link href="#features">
...
console.log('Landing page strictly updated successfully');
